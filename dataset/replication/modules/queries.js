module.exports = {
    ...
    transactionPollingSelect: `select TransactionID, Date, Amount, CardNumberSender, CardNumberReciever, CustomerUUIDSender, CustomerUUIDReciever from Transaction_Polling`,
